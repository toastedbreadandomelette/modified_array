...
MdDynArray<_T2> MdDynArray<_T>::__add_internal(const MdDynArray<_T1> &__other,
                                               const _T2 as) const {
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__add_iinternal(const _T1 &__other,
                                                const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__sub_iinternal(const _T1 &__other,
                                                const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__sub_iointernal(const _T1 &__other,
                                                 const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__mul_internal(const MdDynArray<_T1> &__other,
                                               const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__mul_iinternal(const _T1 &__other,
                                                const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__div_internal(const MdDynArray<_T1> &__other,
                                               const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__div_iinternal(const _T1 &__other,
                                                const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__div_iointernal(const _T1 &__other,
                                                 const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__mod_internal(const MdDynArray<_T1> &__other,
                                               const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__mod_iinternal(const _T1 &__other,
                                                const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
...
template <typename _T>
template <typename _T1, typename _T2>
MdDynArray<_T2> MdDynArray<_T>::__mod_iointernal(const _T1 &__other,
                                                 const _T2 as) const {
    // assert that sizes are equal
    const size_t size = __array.size();
    MdDynArray<_T2> result(size);
