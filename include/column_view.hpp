...
// template MdDynArray<double> ColView::map(const std::function<double(const
// Cell&, const size_t, const ColView&)>&); template MdDynArray<int64_t>
// ColView::map(const std::function<int64_t(const Cell&, const size_t, const
// ColView&)>&); template MdDynArray<uint64_t> ColView::map(const
// std::function<uint64_t(const Cell&, const size_t, const ColView&)>&);
// // template MdDynArray<std::string> ColView::map(const
// std::function<std::string(const Cell&, const size_t, const ColView&)>&);
...
// template MdDynArray<double> ColView::map_mt(const std::function<double(const
// Cell&, const size_t, const ColView&)>&); template MdDynArray<int64_t>
// ColView::map_mt(const std::function<int64_t(const Cell&, const size_t, const
// ColView&)>&); template MdDynArray<uint64_t> ColView::map_mt(const
// std::function<uint64_t(const Cell&, const size_t, const ColView&)>&);
// // template MdDynArray<std::string> ColView::map_mt(const
// std::function<std::string(const Cell&, const size_t, const ColView&)>&);
...
// template MdStaticArray<double> ColView::st_map(const
// std::function<double(const Cell&, const size_t, const ColView&)>&); template
// MdStaticArray<int64_t> ColView::st_map(const std::function<int64_t(const
// Cell&, const size_t, const ColView&)>&); template MdStaticArray<uint64_t>
// ColView::st_map(const std::function<uint64_t(const Cell&, const size_t, const
// ColView&)>&);
// // template MdStaticArray<std::string> ColView::st_map(const
// std::function<std::string(const Cell&, const size_t, const ColView&)>&);
...
// template MdStaticArray<double> ColView::st_map_mt(const
// std::function<double(const Cell&, const size_t, const ColView&)>&); template
// MdStaticArray<int64_t> ColView::st_map_mt(const std::function<int64_t(const
// Cell&, const size_t, const ColView&)>&); template MdStaticArray<uint64_t>
// ColView::st_map_mt(const std::function<uint64_t(const Cell&, const size_t,
// const ColView&)>&);
// // template MdStaticArray<std::string> ColView::st_map_mt(const
// std::function<std::string(const Cell&, const size_t, const ColView&)>&);
