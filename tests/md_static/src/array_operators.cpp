...
int main() {
    MdStaticArray<i32> a(10, 5), b(10, 12);
    {
        auto c = a + b;
        TEST(c.get_size() == 10);
    ...
    {
        auto d = MdStaticArray<i8>({30, 30}, 23) / (8 + 16_i) + 13;
    ...
    {
        auto d =
            MdStaticArray<i8>({30, 30}, 23) & MdStaticArray<i8>({30, 30}, 123);
        TEST_EQ(d.get_size(), 900);
        TEST_EQ(d.get_shape_size(), 2);
        TEST_EQ(d.get_shape()[0], 30);
        TEST_EQ(d.get_shape()[1], 30);
    ...
    {
        auto d = MdStaticArray<f32>({30, 90}, 23) ==
                 MdStaticArray<i8>({30, 90}, 123);
    ...
    {
        auto d = MdStaticArray<usize>({300, 90}, 213) << 12;
    ...
    {
        auto d = MdStaticArray<usize>({312, 123, 11, 2123, 321324})
